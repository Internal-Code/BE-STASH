...
async def get_schema(schema: GetSchema, user:Annotated[dict, Depends(get_current_user)]) -> ResponseDefault:
...
router.add_api_route(
    ...
    summary="Get all schema information of spesific account."
)