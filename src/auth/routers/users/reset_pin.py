...
#     request: ForgotPassword, reset_link_id: str
# ) -> ResponseDefault:
#     response = ResponseDefault()
#     try:
#         reset_id_is_valid = await verify_reset_id(reset_id=reset_link_id)
...
#         user_email = await extract_reset_id(reset_id=reset_link_id)
...
#     methods=["POST"],
#     path="/reset-password/{reset_link_id}",
