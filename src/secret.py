...
ACCESS_TOKEN_JWT_EXPIRED = os.getenv("ACCESS_TOKEN_EXPIRED", "")
ACCESS_TOKEN_JWT_SECRET_KEY = os.getenv("ACCESS_TOKEN_SECRET_KEY", "")
ACCESS_TOKEN_FERNET_SECRET_KEY = os.getenv("ACCESS_TOKEN_FERNET_SECRET_KEY", "")
REFRESH_TOKEN_JWT_EXPIRED = os.getenv("REFRESH_TOKEN_EXPIRED", "")
REFRESH_TOKEN_JWT_SECRET_KEY = os.getenv("REFRESH_TOKEN_SECRET_KEY", "")
REFRESH_TOKEN_FERNET_SECRET_KEY = os.getenv("REFRESH_TOKEN_FERNET_SECRET_KEY", "")
...
WHATSAPP_API_HOST = os.getenv("WHATSAPP_API_HOST", "")
