...
from utils.custom_error import DataNotFoundError, ServiceError, StashBaseApiError, DatabaseQueryError
...
async def get_user_endpoint(
    ...
    try:
        validated_phone_number = PhoneNumberValidatorMixin.validate_phone_number(phone_number=phone_number)
