...
# from services.postgre.models import Users, SendOtps
...
# router = APIRouter(tags=["Wrong Account"], prefix="/user/wrong")
...
#     current_user = await query.find(table=Users, id=id)
#     registered_phone_number = await query.find(
#         table=Users, phone_number=schema.phone_number
#     )
#     otp_record = await query.find(table=SendOtps, unique_id=unique_id)
