...
from services.postgres.models import SendOtp, User, ResetPin
...
async def send_reset_link_endpoint(
    ...
    reset_link = f"http://localhost:8000/api/v1/users/reset-account/reset-pin/{account_record.unique_id}"
