...
class BlacklistToken(SQLModel, table=True):
    ...
    unique_id: Optional[str] = Field(
        default=None, foreign_key="user.unique_id", ondelete="CASCADE"
    )
...
class MonthlySchema(SQLModel, table=True):
    ...
    category_schema: list["CategorySchema"] = Relationship(
        back_populates="monthly_schema", cascade_delete=True
    )
    money_spend: list["MoneySpend"] = Relationship(
        back_populates="monthly_schema", cascade_delete=True
    )
...
class CategorySchema(SQLModel, table=True):
    ...
    month_id: Optional[str] = Field(
        default=None, foreign_key="monthly_schema.month_id", ondelete="CASCADE"
    )
    created_at: datetime = Field(default=local_time())
    updated_at: Optional[datetime] = Field(default=None, nullable=True)
    deleted_at: Optional[datetime] = Field(default=None, nullable=True)
...
class MoneySpend(SQLModel, table=True):
    ...
    category_id: Optional[str] = Field(
        default=None, foreign_key="category_schema.category_id", ondelete="CASCADE"
    )
    month_id: Optional[str] = Field(
        foreign_key="monthly_schema.month_id", ondelete="CASCADE"
    )
    created_at: datetime = Field(default=local_time())
    updated_at: Optional[datetime] = Field(default=None, nullable=True)
    deleted_at: Optional[datetime] = Field(default=None, nullable=True)
    day: Optional[int] = Field(default=None, nullable=True)
    category: Optional[str] = Field(default=None, nullable=True)
    amount: Optional[int] = Field(default=None, nullable=True)
    description: Optional[str] = Field(default=None, nullable=True)
    user: User = Relationship(back_populates="money_spend")
    monthly_schema: MonthlySchema = Relationship(back_populates="money_spend")
